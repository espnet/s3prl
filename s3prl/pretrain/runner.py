...
# -------------#
from optimizers import get_grouped_parameters, get_optimizer
...
class Runner:
    ...
    def train(self):
        ...
        print(
            ...
            train_batch_size * gradient_accumulate_steps,
        )
        ...
        while pbar.n < pbar.total:
            for data in tqdm(dataloader, dynamic_ncols=True, desc="train"):
                ...
                if math.isnan(grad_norm):
                    print(
                        f"[Runner] - Error : grad norm is NaN at global step {global_step}"
                    )
