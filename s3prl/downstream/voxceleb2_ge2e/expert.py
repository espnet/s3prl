...
from .dataset import AudioBatchData, SpeakerVerifi_dev, SpeakerVerifi_test

# -------------#
from .model import GE2E, Model
...
class DownstreamExpert(nn.Module):
    ...
    def __init__(self, upstream_dim, downstream_expert, **kwargs):
        ...
        self.train_dataset = AudioBatchData(
            **self.datarc["train"], batch_size=self.datarc["train_batch_size"]
        )
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.training:
            ...
            GE2E_matrix = agg_vec.reshape(
                -1, self.train_dataset.utter_number, agg_vec.shape[-1]
            )
    ...
    def log_records(self, records, logger, prefix, global_step, **kwargs):
        ...
        if not self.training:
            ...
            logger.add_scalar(
                f"{prefix}" + "EER", records["EER"], global_step=global_step
            )
