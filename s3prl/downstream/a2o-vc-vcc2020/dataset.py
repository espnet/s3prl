    ...
    def __init__(
        ...
        **kwargs
        ...
        if split == "train" or split == "dev":
            file_list = (
                open(
                    os.path.join(lists_root, self.trg_lang + "_" + split + "_list.txt")
                )
                .read()
                .splitlines()
            )
            ...
            file_list = (
                open(os.path.join(lists_root, "eval_list.txt")).read().splitlines()
            )
            X = [
                os.path.join(data_root, srcspk, number + ".wav")
                for number in file_list
...
class CustomDataset(Dataset):
    def __init__(self, eval_list_file, **kwargs):
        ...
        if os.path.isfile(eval_list_file):
            ...
            raise ValueError(
                "[Dataset] eval list file does not exist: {}".format(eval_list_file)
            )
