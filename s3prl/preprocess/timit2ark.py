...
INPUT_PATH = (
    "../data/timit_mel160_phoneme63"  # this can be generated with 'preprocess_timit.py'
)
...
SOURCE_DIR = os.path.join(
    TIMIT_PATH, "data-kaldi-mel"
)  # the data directory generated by kaldi script
OUTPUT_PATH = os.path.join(
    TIMIT_PATH, "timit_mel160_arked"
)  # you should not need to change this
...
def main():
    ...
    for s in OUTPUT_SETS:
        ...
        ark_scp_output = "ark:| copy-feats --compress=true ark:- ark,scp:{}/raw_mel_{}.ark,{}/{}/feats.scp".format(
            OUTPUT_PATH, str(s), OUTPUT_PATH, str(s)
        )
