...
parser.add_argument(
    "--lexicon", help="The lexicon given by LibriSpeech official website"
)
...
all_txt = Parallel(n_jobs=args.njobs)(
    delayed(locate_txt)(flac) for flac in tqdm(list(all_flac), desc="locate txt")
)
all_txt = set(all_txt)
